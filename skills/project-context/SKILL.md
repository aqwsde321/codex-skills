...
- marked 안내가 `docs/project-context.md`, `repository overview`, `architecture notes`, `testing guidance`, `follow its links`, `codebase-memory-mcp`, `$project-context`를 모두 담지 않으면 stale로 본다.
