...
- tracked primary source file이 10개 이하인 작은 repo는 기본 문서와 최대 1-2개 보조 문서만 쓴다.
...
- 기술 구조뿐 아니라 제품/비즈니스 로직과 작업자가 바꿀 때 봐야 할 판단 기준을 담는다.
- 중요한 코드가 어떤 파일에 있는지만 쓰지 말고 왜 존재하는지, 어떤 변경에서 주의해야 하는지 설명한다.
- 같은 개념은 하나의 canonical 문서/섹션에 두고 다른 곳에서는 짧게 링크한다.
